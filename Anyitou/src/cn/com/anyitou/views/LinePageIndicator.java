...
import cn.com.anyitou.utils.CommonHelper;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
       ...
       // final Resources res = getResources();
        ...
        final int defaultSelectedColor = Color.parseColor("#50000000");
        final int defaultUnselectedColor = Color.parseColor("#20000000");
        final float defaultLineWidth =  CommonHelper.getDp2px(context, 24);
        final float defaultGapWidth =  CommonHelper.getDp2px(context,10);
        final float defaultStrokeWidth =  CommonHelper.getDp2px(context,4);
