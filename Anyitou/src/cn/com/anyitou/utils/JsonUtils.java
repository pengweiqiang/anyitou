...
import cn.com.gson.GsonBuilder;
import cn.com.gson.JsonDeserializationContext;
import cn.com.gson.JsonDeserializer;
import cn.com.gson.JsonElement;
import cn.com.gson.JsonParseException;
import cn.com.gson.JsonPrimitive;
import cn.com.gson.JsonSerializationContext;
import cn.com.gson.JsonSerializer;
...
public class JsonUtils {
	...
	public static final int LONG_DATE_PATTERN = DateFormat.LONG;
	...
	public static String toJson(Object target, Type targetType,
		...
		builder.setDateFormat(DateFormat.LONG).setPrettyPrinting();
		if (isSerializeNulls)
		...
		try {
			...
			Log.i("目标对象 " + target.getClass().getName() + " 转换 JSON 字符串时，发生异常！",
					ex.toString());
